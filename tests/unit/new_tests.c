 ...
 */
  ...
  * module / functionality you are testing. Here, it is: new_tests
  *
  ...
  * condition checking.
  */
 CTEST2(new_tests, test_basic_flow)
 {
  ...
  */
 CTEST2(new_tests, test_apis_for_max_key_length)
 {
  ...
  */
 CTEST2(new_tests, test_key_size_gt_max_key_size)
 {
  ...
  */
 CTEST2(new_tests, test_value_size_gt_max_value_size)
 {
  ...
  */
 CTEST2(new_tests, test_variable_length_values)
 {
  ...
  * iterator test case.
  */
 CTEST2(new_tests, test_basic_iterator)
 {
  ...
  */
 CTEST2(new_tests, test_empty_iterator)
 {
    splinterdb_iterator *it = NULL;
  ...
  * initial key value.
  */
 CTEST2(new_tests, test_splinterdb_iterator_with_startkey)
 {
    const int            num_inserts = 50;
    splinterdb_iterator *it          = NULL;
    int                  rc          = insert_some_keys(num_inserts, data->kvsb);
  ...
  */
 CTEST2(new_tests, test_splinterdb_iterator_with_non_existent_startkey)
 {
    int                  rc = 0;
    splinterdb_iterator *it = NULL;
 ...
 CTEST2(new_tests, test_iterator_prev_and_next)
 {
  ...
  */
 CTEST2(new_tests, test_close_and_reopen)
 {
  ...
  */
 CTEST2(new_tests, test_repeated_insert_close_reopen)
 {
 ...
 // data_config
 CTEST2(new_tests, test_custom_data_config)
 {
 ...
 CTEST2(new_tests, test_iterator_custom_comparator)
 {
  ...
  */
 CTEST2(new_tests, test_iterator_init_bug)
 {
    // We need to reconfigure Splinter with user-specified data_config
    // Tear down default instance, and create a new one.
    splinterdb_close(&data->kvsb);
  ...
  * ------------------------------------------------------------------------
  */
 CTEST2(new_tests, test_splinterdb_create_w_background_threads)
 {
    splinterdb_close(&data->kvsb);
  ...
  * ------------------------------------------------------------------------
  */
 CTEST2(new_tests, test_splinterdb_create_w_all_background_threads)
 {
    splinterdb_close(&data->kvsb);
